...
export default function Dashboard({ user, onLogout }) {
  ...
  const PLAN_BLOCKED_TABS = ["planes", "widget", "carrito", "checkout", "retencion", "flujos", "whatsapp", "portal"];
  ...
  const renderTab = (t) => (
    blockedTab(t) ? (
                ...
                integrationsReady ? <CheckoutDesigner section="cart" merchant={merchant} onChange={reloadMerchant}/> : needs("Carrito")
              ) : t === "checkout" ? (
