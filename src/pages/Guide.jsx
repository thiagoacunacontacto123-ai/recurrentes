...
function SecFaq({ T }) {
  const QA = [
    ...
    ["Me aparecen DOS bundles, el mío y el de Recurrentes, uno arriba del otro", "Es el problema más común al empezar y se arregla en un minuto. Recurrentes esconde solo las apps de bundles que reconoce (Kaching, Pumper, Selleasy y una decena más); si usás otra, quedan las dos a la vez. La solución es desactivar la otra: en Shopify, Tienda online → Temas → Personalizar, buscá el bloque de esa app en la página de producto y desactivalo (si la agregó como app embebida, desactivá la app en Aplicaciones). En Tiendanube, Mi Tiendanube → Aplicaciones y desactivá la app de bundles. El widget de Recurrentes ya trae los packs y la suscripción juntos, así que no perdés nada. Si preferís, escribinos por WhatsApp y lo dejamos andando nosotros, gratis."],
