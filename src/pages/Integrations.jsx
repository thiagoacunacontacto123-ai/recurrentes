      ...
      {modal === "meta" && (
        <Modal T={T} title={metaOk ? "Cambiar credenciales de Meta" : "Conectar Meta Ads"} busy={busy === "meta"} onClose={close}
          ...
          <Steps T={T} title="Dos datos de Meta">
            ...
            <li><S T={T}>2 · Token de la API de Conversiones</S>. Entrá al <a href="https://business.facebook.com/events_manager2/list/dataset" target="_blank" rel="noopener noreferrer" style={{ color:T.accent, fontWeight:700 }}>Administrador de eventos</a>, elegí el mismo pixel en la columna izquierda → pestaña <S T={T}>Configuración</S> → bajá hasta <S T={T}>API de conversiones</S> → <S T={T}>Generar token de acceso</S>. Te da un texto muy largo que empieza con <S T={T}>EAA</S>. Copialo entero (Meta lo muestra una sola vez; si lo perdés, generás otro).</li>
          </Steps>
