...
export default function MerchantAlertsSection({ T, merchant, onChange }) {
  ...
  const status = waOn
    ? <>Te llegan por <b style={{ color: T.text }}>WhatsApp</b> desde el número de Recurrentes. Cada aviso cuesta <b style={{ color: T.text }}>{fmtUsdSmall(m.alerts_charge_usd)}</b> y se suma a tu plan a fin de mes.</>
    : mailOn
