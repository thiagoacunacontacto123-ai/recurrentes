...
export function AuthScreen({ T, darkMode, onToggleDark, mode = "login", setMode, onBackToLanding }) {
  ...
  const subtitle = isLogin ? "Entrá a tu panel de suscripciones." : isRegister ? "Beta gratis · sin tarjeta · conectás Shopify y Mercado Pago cuando quieras." : "Te mandamos un link por mail para elegir una contraseña nueva.";
