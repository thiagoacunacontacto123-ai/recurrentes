...
export function AuthScreen({ T, darkMode, onToggleDark, mode = "login", setMode, onBackToLanding }) {
  ...
  const subtitle = isLogin ? "Entrá a tu panel de suscripciones." : isRegister ? "Gratis hasta 5 suscriptores · sin tarjeta · conectás tu tienda y Mercado Pago cuando quieras." : "Te mandamos un link por mail para elegir una contraseña nueva.";
