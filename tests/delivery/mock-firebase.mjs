...
// Tests de handlers: el test setea globalThis.__ctx = { merchantId, uid, email }.
export async function requireMerchant() {
  if (globalThis.__ctx) return globalThis.__ctx;
  throw new Error("no usar en tests (seteá globalThis.__ctx)");
}
