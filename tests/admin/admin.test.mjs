...
// ─── 2) Resumen ──────────────────────────────────────────────────────────────
{
  ...
  ok(o.subs.mrr === 159000, "MRR total = 24.000 + 15.000 + 120.000", o.subs);
...
// ─── 4) Ficha ────────────────────────────────────────────────────────────────
{
  ...
  ok(r.body.stats?.subs === 15 && r.body.stats?.mrr === 15000 && m.whatsapp_url === "https://wa.me/5491122223333", "ficha: números recalculados + WhatsApp");
